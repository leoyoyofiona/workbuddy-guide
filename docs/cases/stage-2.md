---
title: 第 2 段｜10 个基本场景案例
description: 用工作、学习、生活、娱乐、创意、设计和生产力中的小任务，练会把 WorkBuddy 用到日常。
sourceStatus: template
verifiedAt: 2026-08-11
officialLinks:
  - https://www.workbuddy.cn/work/
  - https://cloud.tencent.com.cn/product/workbuddy
permalink: /cases/stage-2/
---

# 第 2 段：10 个基本场景案例

这一段不讲“高深玩法”。你只要把手头的一件小事交给 WorkBuddy：说清楚目标，给足材料，最后自己验收。每个案例都可以先用一小份脱敏内容试跑。

<div class="evidence-card"><strong>先记一句话</strong><span>资料不完整，就先让它提问；资料已经齐，就让它直接做；结果要发给别人，就一定自己检查。</span></div>

<p><a class="wb-inline-link" href="/videos/#第-2-段基本场景">先看第 2 段真实桌面录屏，再挑一个日常场景跟练 →</a></p>

## 案例 01｜工作：做一份日报

目标：把零散的工作记录变成可以发给同事的日报。
...
```text
请把下面的工作记录整理成日报：完成事项｜当前进度｜阻塞问题｜明日计划。
只使用我提供的事实，不要补写不存在的结果。
```

<div class="wb-case-check"><strong>做完看这里：</strong>同事能在 30 秒内看懂你做了什么、卡在哪里、明天做什么。</div>

## 案例 02｜学习：文章变知识卡

目标：把一篇长文章变成能复习的卡片，不是机械抄摘要。
...
<div class="wb-case-check"><strong>做完看这里：</strong>你能不看原文说出概念，并能用自己的例子解释。</div>

## 案例 03｜生活：排一个周末行程

目标：把“想去几个地方”的模糊想法变成按时间排列的方案。
...
<div class="wb-case-check"><strong>做完看这里：</strong>行程里有时间、费用和备选；实时营业信息仍要回官方渠道确认。</div>

## 案例 04｜娱乐：做一张观影清单

目标：把“随便推荐几部”变成有筛选条件的清单。
...
<div class="wb-case-check"><strong>做完看这里：</strong>推荐理由能对应你的条件；上映、平台和排片信息请自行核实。</div>

## 案例 05｜创意：想 10 个内容选题

目标：先发散，再挑选，不用一开始就纠结“哪一个最完美”。
...
<div class="wb-case-check"><strong>做完看这里：</strong>选题不是越夸张越好，而是读者看完能马上做一件事。</div>
...
<div class="wb-case-check"><strong>做完看这里：</strong>只看 5 个标题，也能讲清“为什么、怎么办、要什么决定”。</div>

## 案例 07｜生产力：检查一张表

目标：让 WorkBuddy 帮你找格式问题，你来决定怎么改。
...
<div class="wb-case-check"><strong>做完看这里：</strong>原表保留一份不动的备份，所有修改都有记录。</div>

## 案例 08｜通知：把硬话说柔和

目标：同一件事换一种说法，让对方听得懂也愿意行动。
...
<div class="wb-case-check"><strong>做完看这里：</strong>语气变柔和，但截止时间和行动要求没有变。</div>

## 案例 09｜会议：纪要加跟进消息

目标：会后不用重新写两遍，把纪要和跟进消息一次整理好。
...
<div class="wb-case-check"><strong>做完看这里：</strong>每条消息都能回到会议原文，不把讨论意见写成最终决定。</div>

## 案例 10｜反馈：把意见分成几类

目标：先用简单分类看清问题集中在哪里，再决定要不要统计。
...
<div class="wb-case-check"><strong>做完看这里：</strong>你能找到最多的 1～2 类问题，并保留原始反馈方便复查。</div>

<p class="source-note">本页是通用场景模板，不代表 WorkBuddy 对所有文件、平台或数据源都提供相同能力。请先用少量、脱敏、可撤回的资料测试。</p>
